                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>REGISTRO DE USUARIOS - ESTUDIANTES</h4>
                            <br>
                            <a href="reportes/r_usuarioes.php" target="_blank" class="btn btn-danger" >PDF</a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tbody class="text-dark">
                                        <?php
                                            $query="SELECT * FROM estudiante where tipoe='estudiante' and numdoce!='';";
