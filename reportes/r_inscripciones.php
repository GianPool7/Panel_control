...
$pdf->Cell(100,6,'Inscritos',0,0,'C');
...
$pdf->Cell(25,6,'Teléfono',1,1,'C',1);
...
*/
$sqlTrabajadores = ("SELECT * FROM inscripcionesasesorias;");
//$sqlTrabajadores = ("SELECT * FROM trabajadores");
$query = mysqli_query($conne, $sqlTrabajadores);

while ($dataRow = mysqli_fetch_array($query)) {
        $pdf->Cell(45,6,($dataRow['nombreia']),1,0,'C');
        $pdf->Cell(40,6,$dataRow['apellidosia'],1,0,'C');
        $pdf->Cell(25,6,($dataRow['telefonoia']),1,0,'C');
        $pdf->Cell(65,6,($dataRow['carreraia']),1,0,'C');
        $pdf->Cell(25,6,($dataRow['actual']),1,1,'C');
    }
