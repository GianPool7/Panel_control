...
$pdf->SetCreator('ibp');
$pdf->SetAuthor('ibp');
$pdf->SetTitle('Reporte de usuarios Egresados');
...
$pdf->Cell(100,6,'REPORTE DE INSERCIÓN LABORAL',0,0,'C');
...
$pdf->Cell(43,6,'Nombres',1,0,'C',1);
$pdf->Cell(43,6,'Apellidos',1,0,'C',1);
$pdf->Cell(65,6,'Carrera',1,0,'C',1);
$pdf->Cell(20,6,'Trabaja',1,0,'C',1);
$pdf->Cell(120,6,'Nombre o Razon Social',1,1,'C',1);
...
while ($dataRow = mysqli_fetch_array($query)) {
        $pdf->Cell(43,6,($dataRow['nombrese']),1,0,'C');
        $pdf->Cell(43,6,$dataRow['apellidose'],1,0,'C');
        $pdf->Cell(65,6,$dataRow['carrerae'],1,0,'C');
        $pdf->Cell(20,6,($dataRow['labura']),1,0,'C');
        $pdf->Cell(120,6,($dataRow['nombreempresaestud']),1,1,'C');
