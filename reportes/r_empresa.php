...
$pdf->SetCreator('ibp');
$pdf->SetAuthor('ibp');
$pdf->SetTitle('Informe de Empresas');
...
$pdf->Cell(100,6,'Data de Empresas',0,0,'C');
...
*/
$sqlTrabajadores = ("SELECT * FROM empresa");
...
while ($dataRow = mysqli_fetch_array($query)) {
        ...
        $pdf->Cell(30,6,$dataRow['nruce'],1,0,'C');
        $pdf->Cell(40,6,($dataRow['programaee']),1,0,'C');
        $pdf->Cell(70,6,($dataRow['correoe']),1,0,'C');
        $pdf->Cell(50,6,($dataRow['distritoe']),1,1,'C');
    }
