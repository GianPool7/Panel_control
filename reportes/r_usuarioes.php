...
$pdf->Cell(100,6,'Lista de usuarios egresados',0,0,'C');
...
$pdf->Cell(80,6,'Contraseña',1,1,'C',1);
...
while ($dataRow = mysqli_fetch_array($query)) {
        ...
        $pdf->Cell(45,6,($dataRow['apellidose']),1,0,'C');
        $pdf->Cell(65,6,($dataRow['carrerae']),1,0,'C');
        $pdf->Cell(25,6,($dataRow['numdoce']),1,0,'C');
        $pdf->Cell(80,6,($dataRow['passestu']),1,1,'C');
    }
