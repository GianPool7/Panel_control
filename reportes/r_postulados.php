...
$pdf->Cell(35,6,'Alumno',1,0,'C',1);
$pdf->Cell(90,6,'Puesto',1,0,'C',1);
$pdf->Cell(100,6,'Razón Social',1,0,'C',1);
$pdf->Cell(65,6,'Estado',1,1,'C',1);
...
*/
$sqlTrabajadores = ("SELECT nombrese,apellidose,puestot,nombrerze,estado
                    FROM postular
...
while ($dataRow = mysqli_fetch_array($query)) {
        $pdf->Cell(35,6,($dataRow['nombrese']),1,0,'C');
        $pdf->Cell(90,6,$dataRow['puestot'],1,0,'C');
        $pdf->Cell(100,6,($dataRow['nombrerze']),1,0,'C');
        $pdf->Cell(65,6,($dataRow['estado']),1,1,'C');
    }
