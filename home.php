        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">T. Egresados <br> 2019-I / 2023-I</div>
                                    
                                    <?php
                                                                            
                                        $nump="SELECT * FROM redusys;";
                                        $resulte=mysqli_query($conne,$nump);
                                        $counte=mysqli_num_rows($resulte);
                                        ?>

                                    <?php ?>

                                    <div class="stat-digit"><?php echo $counte?></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Egresados <br> Contactados</div>

                                    <?php
                                                                            
                                        $nume="SELECT * FROM estudiante where tipoe!='estudiante';";
                                        $resulte=mysqli_query($conne,$nume);
                                        $countegre=mysqli_num_rows($resulte);
                                        ?>

                                    <?php ?>

                                    <div class="stat-digit"><?php echo $countegre?></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Egresados <br> Laboran</div>   

                                    <?php                                
                                        $numetra="SELECT * FROM estudiante where labura='si'and tipoe!='estudiante' ";
                                        $resulte=mysqli_query($conne,$numetra);
                                        $countegretra=mysqli_num_rows($resulte);
                                        ?>

                                    <?php ?>

                                    <div class="stat-digit"><?php echo $countegretra?></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Egresados <br> No Laboran</div>

                                    <?php                                
                                        $numetran="SELECT * FROM estudiante where labura='no' and tipoe!='estudiante' ";
                                        $resulte=mysqli_query($conne,$numetran);
                                        $countegretran=mysqli_num_rows($resulte);
                                        ?>

                                    <?php ?>

                                    <div class="stat-digit"><?php echo $countegretran?></div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div id="calendario" class="app-fullcalendar"></div>
                        </div>
                    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                        ...
                                        <form>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control form-white" placeholder="Agregar Evento" type="text" name="category-name">
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary waves-effect waves-light save-category" data-dismiss="modal">Guardar</button>
                                    </div>
                                </div>
                            </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="">
                                    <img class="img-thumbnail" src="images/egresados.png" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body text-left">
                                <div class="">
                                    <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fbolsadeempleoibp%3Flocale%3Des_LA&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500px" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                </div>
                            </div>
                        </div>
