        ...
        <div class="quixnav">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="home.php" href="../home.php" aria-expanded="false"><i
                    ...
                    <!--- graficoegresado.php -->
                    <li>
                        <a href="seguimientografcio.php" aria-expanded="false"><i class="fas fa-chart-bar"></i><span
                    ...
                    <li>
                        <a href="inserciongraficos.php" aria-expanded="false"><i class="fas fa-chart-bar"></i><span
                        class="nav-text">Gráficos</span>
                        </a>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="empresasgrafico.php">Gráficos</a></li>
                        </ul>
                    </li>
