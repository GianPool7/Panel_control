              ...
              <div class="col">
                ...
                <form class="row g-3 p-5" action="" method="">
                    ...
                    <div id="mostrarestudiante" class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <br>
                          ...
                          <div class="col-md-12">
                            <label for="inputState" class="form-label font-weight-bold text-dark">Estado Laboral</label>
                          </div>
                    ...
                    <div class="row" id="satis">
                        ...
                        <div class="col-md-12">
                        <label for="inputState" class="form-label font-weight-bold text-dark">SATISFACTION DE EGRESADOS</label>
                        </div>
                        ...
                        <div class="row p-4" >
                            ...
                            <br><br>
                                ...
                                <div class="col-md-6">
                                    <input class="form-check-input border-primary" type="radio" id="silbl" value="si" name="p1">
                                    <label for="silbl">Si</label>
                                </div>
                                
                                <div class="col-md-6">
                                    <input class="form-check-input border-primary" type="radio" id="nolbl" value="no" name="p1">
                                    <label for="nolbl">No</label>
                                </div>
                        ...
                        <div class="row p-4" >
                            ...
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sat1" value="Muy satisfecho" name="p2">
                                <label for="sat1">Muy satisfecho</label>
                            </div>
                            
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sat2" value="Moderadamente satisfecho" name="p2">
                                <label for="sat2">Moderadamente satisfecho</label>
                            </div>
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sat3" value="Poco satisfecho" name="p2">
                                <label for="sat3">Poco satisfecho</label>
                            </div>
                            
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sat4" value="Para nada satisfecho" name="p2">
                                <label for="sat4">Para nada satisfecho</label>
                            </div>
                        ...
                        <div class="row p-4" >
                            ...
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sati1" value="Muy satisfecho" name="p3">
                                <label for="sati1">Muy satisfecho</label>
                            </div>
                            
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sati2" value="Moderadamente satisfecho" name="p3">
                                <label for="sati2">Moderadamente satisfecho</label>
                            </div>
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sati3" value="Poco satisfecho" name="p3">
                                <label for="sati3">Poco satisfecho</label>
                            </div>
                            
                            <div class="col-md-3" >
                                <input class="form-check-input border-primary" type="radio" id="sati4" value="Para nada satisfecho" name="p3">
                                <label for="sati4">Para nada satisfecho</label>
                            </div>
                        ...
                        <div class="row p-4" >
                            ...
                            <div class="col-md-6" >
                                <input class="form-check-input border-primary" type="radio" id="sire" value="si" name="p5">
                                <label for="sire">Si</label>
                            </div>
                            
                            <div class="col-md-6" >
                                <input class="form-check-input border-primary" type="radio" id="Nore" value="no" name="p5">
                                <label for="Nore">No</label>
                            </div>
                        ...
                        <div class="row p-4" >
                            ...
                            <div class="col-md-12">
                                ...
                                <h6>¿Qué sugerencias haría usted, para mejorar la formación profesional de la carrera que estudió?</h6>
                            ...
                            <div class="mb-12">
                                ...
                                <div class="col-md-12" >
                                    <input class="form-check-input border-primary" type="radio" id="Nore" value="no" name="p5">
                                    <textarea class="form-control border-primary" id="exampleFormControlTextarea1" rows="3" name="p4"></textarea>
                                </div>
                    ...
                    <div class="col-12 p-4">
                    <button type="submit" class="btn btn-primary" id="guardar" name="registrarestud"><b>Enviar Datos</b></button>
                    </div>
